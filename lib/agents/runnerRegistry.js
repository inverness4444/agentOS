...
const { buildUnifiedSystemPromptForAgent, resolveAgentRole } = require("./rolePolicy.js");

const withUnifiedPrompt = (displayName, fallbackPrompt) => {
  const role = resolveAgentRole({ name: displayName, systemPrompt: fallbackPrompt });
...
const runners = [
  {
    ...
    systemPrompt: withUnifiedPrompt(platon.platonAgent.displayName, platon.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(anatoly.anatolyAgent.displayName, anatoly.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(timofey.timofeyAgent.displayName, timofey.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(maxim.maximAgent.displayName, maxim.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(fedor.fedorAgent.displayName, fedor.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(artem.artemAgent.displayName, artem.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(leonid.leonidAgent.displayName, leonid.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(emelyan.emelyanAgent.displayName, emelyan.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(boris.borisAgent.displayName, boris.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(pavel.pavelAgent.displayName, pavel.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(trofim.trofimAgent.displayName, trofim.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(irina.irinaAgent.displayName, irina.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(hariton.haritonAgent.displayName, hariton.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(kostya.kostyaAgent.displayName, kostya.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(seva.sevaAgent.displayName, seva.systemPrompt),
  ...
  },
  {
    ...
    systemPrompt: withUnifiedPrompt(mitya.mityaAgent.displayName, mitya.systemPrompt),
